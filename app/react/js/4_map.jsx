...
init.menuText =
  [
    ...
    <aircle className="clearfix">
      ...
      <h2>作者自介</h2>
      <p>作者本名叫 盧宏寶 在家排名老二，畢業於高雄市正修科技大學電機工程系，在網路世界中暱稱為 DKBO，目前已婚有一子。<br /><br />第一份的正式工作在<mark>宗賢有限公司</mark>，擔任<mark>系統工程師</mark>，利用 ABB 的 MicroSCADA　建置、維護系統，接觸到 ModBus、TCP/IP、optical 等通訊協定，簡單來說就是用電腦來監控廠房內的設備，並即時接收/傳入訊號至設備。<br /><br />第二份工作在<mark>威鴻數位工程有限公司</mark>，擔任<mark>系統工程師</mark>，公司營運以監控設備的維護及安裝，並代理藍眼補習班補課系統。在職期間負責監工器材的安裝，及系統配置。<br /><br />第三份工作在<mark>台灣惠多笑有限公司</mark>，擔任網頁工程師，目前在職中。主要在於維護或架設官方網站、依老闆需求製作海報文宣品，並負責維護公司電腦及網路。</p>
    </aircle>
    ,
    <aircle className="clearfix">
      <h2>電腦熱鍵</h2>
