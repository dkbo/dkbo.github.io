...
init.objects=[{
  ...
  styles : [{name:"largetree",id:0,left: 800,top:200,width:8*sX,height:7*sY,background: init.object.sprites,sourceX :0 ,sourceY: 1056,zIndex : 2},
           ...
           {name:"house",id:2,left: 400,top:300,width:3*sX,height:6*sY,background: init.object.sprites,sourceX :0 ,sourceY:5216,zIndex : 2,mx:400,my:300+2*sY,mw:7*sX,mh:sY*5},
            {name:"house",id:2,left: 400,top:492,width:3*sX,height:sY*2,background: init.object.sprites,sourceX :0 ,sourceY:5408,zIndex : 0,mx:400,my:300+2*sY,mw:7*sX,mh:sY*4},
            
            {name:"house",id:2,left: 492,top:300,width:sX,height:6*sY,background: init.object.sprites,sourceX :64 ,sourceY:5216,zIndex : 2},
            {name:"house",id:2,left: 524,top:300,width:sX,height:7*sY,background: init.object.sprites,sourceX :64 ,sourceY:5216,zIndex : 2},
            {name:"house",id:2,left: 556,top:300,width:sX,height:6*sY,background: init.object.sprites,sourceX :96 ,sourceY:5216,zIndex : 2},
            {name:"house",id:2,left: 588,top:300,width:sX,height:7*sY,background: init.object.sprites,sourceX :128 ,sourceY:5216,zIndex : 2},
            {name:"house",id:2,left: 588,top:524,width:sX,height:sY,background: init.object.sprites,sourceX :128 ,sourceY:5440},
            {name:"housedoor",id:2,left: 492,top:492,width:sX,height:2*sY,background: init.object.sprites,sourceX :96 ,sourceY:5408,mx:492,my:492,mw:sX,mh:sY,cm:1,cmm : 0},
            {name:"house",id:2,left: 556,top:492,width:sX,height:sY,background: init.object.sprites,sourceX :64 ,sourceY:5408},
            {name:"house",id:2,left: 556,top:524,width:sX,height:sY,background: init.object.sprites,sourceX :64 ,sourceY:5440},
            {name:"house",id:2,left: 524,top:524,width:sX,height:sY,background: init.object.sprites,sourceX :64 ,sourceY:5440},
            {name:"wood",id:2,left: 524,top:524,width:2*sX,height:2*sY,background: init.object.sprites,sourceX :192 ,sourceY:4672,mx:524,my:524,mw:2*sX,mh:sY*1}
            ,
