...
init.menuText =
  [
    ...
    <aircle className='clearfix'>
      ...
      <h2>遊戲內容</h2>
      <p>本網站可以僅利用前端，構造出無限個地圖、人物、事件，雖然無戰鬥事件(回合制、即時制)，及一些特殊機制，但已經達到初衷。學習了很多很棒的程式。在製作時間有人問說，怎不用現成 unity 去做，其實也只能一笑置之。第一沒學過 unity，第二剛好有空閒時間又可以練習程式，何樂而不為呢。</p>
    </aircle>
    ,
    <aircle className='clearfix'>
      <h2>作者</h2>
      ...
      <h2>聯絡作者</h2>
      <p>如有任何建議、問題、分享都可以透過下列方式聯繫我!</p>
      <p>電子郵件: <a href="mailto:dk880842@gmail.com">dk880842@gmail.com</a></p>
      <p>LineID: <a href="http://line.me/ti/p/oL-C98W6OF">dk880842</a></p>
      <h2>技能專長</h2>
